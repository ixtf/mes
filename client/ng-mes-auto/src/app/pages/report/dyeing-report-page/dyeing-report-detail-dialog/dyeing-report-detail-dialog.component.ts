...
import {DyeingReportItem} from '../dyeing-report-page.state';

@Component({
  templateUrl: './dyeing-report-detail-dialog.component.html',
  styleUrls: ['./dyeing-report-detail-dialog.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DyeingReportDetailDialogComponent {
  ...
  constructor(private api: ApiService,
              ...
              private dialogRef: MatDialogRef<DyeingReportDetailDialogComponent>,
  ...
  static open(dialog: MatDialog, data: DyeingReportItem) {
    dialog.open(DyeingReportDetailDialogComponent, {data, width: '800px'});
  }
