...
@Component({
  ...
  styleUrls: ['./inspection-report-detail-dialog.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class InspectionReportDetailDialogComponent {
  ...
  static open(dialog: MatDialog, data: InspectionReportItem) {
    dialog.open(InspectionReportDetailDialogComponent, {data, width: '800px'});
  }
