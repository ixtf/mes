...
@Component({
  templateUrl: './to-dty-confirm-report-detail-dialog.component.html',
  styleUrls: ['./to-dty-confirm-report-detail-dialog.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ToDtyConfirmReportDetailDialogComponent {
  ...
  constructor(private api: ApiService,
              ...
              private dialogRef: MatDialogRef<ToDtyConfirmReportDetailDialogComponent>,
  ...
  static open(dialog: MatDialog, data: StrippingReportItem) {
    dialog.open(ToDtyConfirmReportDetailDialogComponent, {data, width: '800px'});
  }
