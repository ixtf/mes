...
@Component({
  templateUrl: './to-dty-report-detail-dialog.component.html',
  styleUrls: ['./to-dty-report-detail-dialog.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ToDtyReportDetailDialogComponent {
  ...
  constructor(private api: ApiService,
              ...
              private dialogRef: MatDialogRef<ToDtyReportDetailDialogComponent>,
  ...
  static open(dialog: MatDialog, data: StrippingReportItem) {
    dialog.open(ToDtyReportDetailDialogComponent, {data, width: '800px'});
  }
