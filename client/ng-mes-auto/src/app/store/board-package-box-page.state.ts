...
export class InitAction {
  static readonly type = '[BoardPackageBoxPage] InitAction';
}

export class QueryAction {
  static readonly type = '[BoardPackageBoxPage] QueryAction';
...
export class BoardPackageBoxPageState {
